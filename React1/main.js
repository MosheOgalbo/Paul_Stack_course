...
const ProductsWindow = () => {
    ...
    const productListDisplay = listOpject.map((element) => (
        <ProductForDisplay
            title={element.title}
            image={element.image}
